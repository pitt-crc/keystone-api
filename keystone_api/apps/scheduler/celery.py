...
celery_app.conf.beat_schedule = {
    ...
    'apps.allocations.tasks.notify_upcoming_expirations': {
        ...
        'schedule': crontab(hour='0', minute='0'),
        'description': 'This task sends email notifications informing users of upcoming expirations.'
    },
    'apps.allocations.tasks.notify_past_expirations': {
        'task': 'apps.allocations.tasks.notify_past_expirations',
        'schedule': crontab(hour='0', minute='0'),
        'description': 'This task sends email notifications informing users their proposals have expired.'
    },
}
